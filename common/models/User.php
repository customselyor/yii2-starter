...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    {
        if (static::findOne((string)$token->getClaim('uid'))){
            return new static(static::findOne(['id' => (string) $token->getClaim('uid'), 'status' => self::STATUS_ACTIVE]));
        }
//        print_r($token->getClaim('uid'));
//        die();
//        foreach (self::us as $user) {
