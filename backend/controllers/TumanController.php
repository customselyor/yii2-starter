...
use backend\models\search\TumanSearch;
...
class TumanController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        return $this->render('create', [
            'model' => $model,
            'viloyatlar' => Viloyat::find()->localized(Yii::$app->language)->active()->all(),
        ]);
    }
    ...
    {
        if (($model = Tuman::find()->multilingual()->andWhere(['id' => $id])->one()) !== null) {
            return $model;
        }
